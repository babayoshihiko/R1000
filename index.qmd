...
これまで、Zoom を使ってオンラインで RStudio 勉強会を開催してきました。時間帯は早朝 7:30-9:00 という朝活です。この勉強会は現在でも継続しています。

```{=html}
<iframe width="780" height="500" src="https://saturdaymorning.connpass.com/" title="Quarto Documentation"></iframe>
```
